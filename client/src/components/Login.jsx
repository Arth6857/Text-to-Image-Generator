...
const Login = () => {
    ...
    //if state is logion or not we have to provide backendUrl which is in Appcontext
    //same for token and setToken and setUser
    ...
    viewport={{ once: true }}
      className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
         ...
         <button type="submit" className='className="mt-4 bg-blue-600 text-white py-2 px-8 rounded-full block mx-auto'>
...
//           setShowLogin(false) // close signup modal
//         } else {
//           toast.error(data.message)
//         }
//       }
